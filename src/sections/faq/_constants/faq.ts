...
export const faqItems: FaqItem[] = [ {
  ...
  },
  {
    ...
    answer:
      "I bring a blend of product strategy, business thinking, and full-stack engineering. Not just code execution. I approach development with an open mind and believe in removing unnecessary abstractions whenever possible."
  },
  {
  ...
  },
  {
    ...
    answer:
      "AI should enhance workflows and decision-making, not replace core functionality.  It’s the muscle, not the brain."
  }
];
